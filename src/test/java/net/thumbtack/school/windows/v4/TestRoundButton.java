...
public class TestRoundButton {
    ...
    @Test
    public void testRoundButtonCreateDestroyedWindow() throws WindowException {
        try {
            Point center = new Point(10, 10);
            RoundButton roundButton = new RoundButton(center, 10, WindowState.DESTROYED, "OK");
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.WRONG_STATE, ex.getWindowErrorCode());
        }
    }
    ...
    @Test
    public void testRoundButtonCreateDestroyedWindow2() throws WindowException {
        try {
            Point center = new Point(10, 10);
            RoundButton roundButton = new RoundButton(center, 10, "DESTROYED", "OK");
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.WRONG_STATE, ex.getWindowErrorCode());
        }
    }
    ...
    @Test
    public void testRoundButtonCreateDestroyedWindow3() throws WindowException {
        try {
            RoundButton roundButton = new RoundButton(10, 20, 10, WindowState.DESTROYED, "OK");
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.WRONG_STATE, ex.getWindowErrorCode());
        }
    }
    ...
    @Test
    public void testRoundButtonCreateDestroyedWindow4() throws WindowException {
        try {
            RoundButton roundButton = new RoundButton(10, 20, 10, "DESTROYED", "OK");
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.WRONG_STATE, ex.getWindowErrorCode());
        }
    }
