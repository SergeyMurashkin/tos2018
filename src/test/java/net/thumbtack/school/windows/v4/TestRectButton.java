...
public class TestRectButton {
    ...
    @Test
    public void testRectButtonCreateDestroyedWindow() throws WindowException {
        try {
            Point topLeft = new Point(10,10);
            Point bottomRight = new Point(20,20);
            RectButton rectButton = new RectButton(topLeft, bottomRight, WindowState.DESTROYED, "OK");
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.WRONG_STATE, ex.getWindowErrorCode());
        }
    }
    ...
    @Test
    public void testRectButtonCreateDestroyedWindow2() throws WindowException {
        try {
            Point topLeft = new Point(10,10);
            Point bottomRight = new Point(20,20);
            RectButton rectButton = new RectButton(topLeft, bottomRight, "DESTROYED", "OK");
        } catch (WindowException ex) {
            assertEquals(WindowErrorCode.WRONG_STATE, ex.getWindowErrorCode());
        }
    }
