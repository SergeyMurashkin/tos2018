...
public class TestComboBox {
    ...
    @Test
    public void testWindowErrorCodeGetErrorString() throws WindowException{
        String[] lines = {"line1", "line2", "line3"};
        ComboBox comboBox1 = new ComboBox(10, 20, 30, 40, lines, 1);
        try {
            comboBox1.setSelected(3);
        }
        catch (WindowException ex) {
            assertEquals("Передан недопустимый индекс для массива строк.", ex.getWindowErrorCode().getErrorString());
        }
