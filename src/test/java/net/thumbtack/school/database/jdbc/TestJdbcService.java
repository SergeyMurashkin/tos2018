...
public class TestJdbcService {
    ...
    public void testInsertTwoSchoolsAndGroups() throws SQLException {
        School school2017 = new School("TTSchool2017", 2017);
        JdbcService.insertSchool(school2017);
        ...
        schools.add(school2017);
        schools.add(school2018);
        schools.add(school2019);
        School school2017FromDBWithGroups = JdbcService.getSchoolByIdWithGroups(school2017.getId());
        assertEquals(school2017, school2017FromDBWithGroups);
        School school2018FromDBWithGroups = JdbcService.getSchoolByIdWithGroups(school2018.getId());
        assertEquals(school2018, school2018FromDBWithGroups);
        School school2019FromDBWithGroups = JdbcService.getSchoolByIdWithGroups(school2019.getId());
        assertEquals(school2019, school2019FromDBWithGroups);
