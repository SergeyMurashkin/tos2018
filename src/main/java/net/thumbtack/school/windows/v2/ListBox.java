...
public class ListBox {
    ...
    public boolean isIntersects(ListBox listBox) {
        return listBox.getTopLeft().getX() + listBox.getWidth() > getTopLeft().getX()
                && listBox.getTopLeft().getX() < getTopLeft().getX() + getWidth()
                && listBox.getTopLeft().getY() + listBox.getHeight() > getTopLeft().getY()
                && listBox.getTopLeft().getY() < getTopLeft().getY() + getHeight();
    }

    public boolean isInside(ListBox listBox) {
        return listBox.getTopLeft().getX() >= getTopLeft().getX()
                && listBox.getTopLeft().getX() + listBox.getWidth() <= getTopLeft().getX() + getWidth()
                && listBox.getTopLeft().getY() >= getTopLeft().getY()
                && listBox.getTopLeft().getY() + listBox.getHeight() <= getTopLeft().getY() + getHeight();
    }
